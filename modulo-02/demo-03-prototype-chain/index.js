...
// __proto__ é a referência de objeto que possui as propriedades nele
...
// podemos chamar via prototype, mas chamar direto resulta em erro
...
console.log('manager.__proto__: %s, \nmanager.salary(): %s',new Manager().__proto__, new Manager().salary());
