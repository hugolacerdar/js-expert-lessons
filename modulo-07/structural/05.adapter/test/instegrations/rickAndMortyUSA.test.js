...
describe("#RickAndMortyUSA", () => {
  ...
  test("#getCharactersXML should resturn a list of Characters Entity", async () => {
  ...
  test("#getCharactersXML should resturn an empty list if the API returns nothing", async () => {
