...
describe('Test Suite for Observer Pattern', () => {
    ...
    test('#Payment should notify subject after credit card transaction observers', () => {
        const subject = new PaymentSubject();
        ...
        const data = { userName: 'hugolacerda', id: Date.now()};
        payment.creditCard(data);

        expect(paymentSubjectNotifierSpy).toBeCalledWith(data);
    });
    test('#All should notify subscribers after credit card payment', () => {
        const subject = new PaymentSubject();
