...
const postgresConnectionString = "postgres://hugolacerda:123456@localhost:5432/heroes"
const postgresContext = new ContextStrategy(new PostgresStrategy(postgresConnectionString));

await postgresContext.connect();

const mongoDBConnectionString = "mongodb://hugolacerda:123456@localhost:27017/heroes";
